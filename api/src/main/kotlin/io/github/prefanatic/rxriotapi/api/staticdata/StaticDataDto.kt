...
data class SummonerSpellList(val data: MutableMap<String, SummonerSpell>, val type: String, val version: String): Dto
data class SummonerSpell(val cooldown: MutableList<Double>, val cooldownBurn: String, val cost: MutableList<Int>, val costBurn: String, val costType: String,
                         ...
                         val resource: String, val sanitizedDescription: String, val sanitizedTooltip: String, val summonerLevel: Int, val tooltip: String, val vars: MutableList<SpellVars>): Dto

data class RuneList(val basic: BasicData, val data: MutableMap<String, Rune>, val type: String, val version: String): Dto
...
data class BasicData(val colloq: String, val consumeOnFull: Boolean, val consumed: Boolean, val depth: Int, val description: String, val from: MutableList<String>, val gold: Gold,
                     ...
                     val stats: BasicDataStats, val tags: MutableList<String>): Dto
...
data class Rune(val colloq: String, val consumeOnFull: Boolean, val consumed: Boolean, val depth: Int, val description: String, val from: MutableList<String>,
                ...
                val stacks: Int, val stats: BasicDataStats, val tags: MutableList<String>): Dto
...
data class Mastery(val description: MutableList<String>, val id: Int, val image: Image, val masteryTree: String, val name: String, val prereq: String, val ranks: Int, val sanitizedDescription: MutableList<String>): Dto
data class MasteryTree(val Defense: MutableList<MasteryTreeList>, val Offense: MutableList<MasteryTreeList>, val Utility: MutableList<MasteryTreeList>): Dto
data class MasteryTreeList(val masteryTreeItems: MutableList<MasteryTreeItem>): Dto
data class MasteryTreeItem(val masteryId: Int, val prereq: String): Dto

data class MapData(val data: MutableMap<String, MapDetails>, val type: String, val version: String): Dto
data class MapDetails(val image: Image, val mapId: Long, val mapName: String, val unpurchasableItemList: MutableList<Long>): Dto

data class LanguageStrings(val data: MutableMap<String, String>, val type: String, val version: String): Dto
...
data class Group(val MaxGroupOwnable: String, val key: String): Dto
data class Item(val colloq: String, val consumeOnFull: Boolean, val consumed: Boolean, val depth: Int, val description: String, val effect: MutableMap<String, String>,
                ...
                val specialRecipe: Int, val stacks: Int, val stats: BasicDataStats, val tags: MutableList<String>): Dto
...
data class BasicDataStats(val FlatArmorMod: Double, val FlatAttackSpeedMod: Double, val FlatBlockMod: Double,
                          ...
                          val rPercentTimeDeadMod: Double, val rPercentTimeDeadModPerLevel: Double): Dto

data class Gold(val base: Int, val purchasable: Boolean, val sell: Int, val total: Int): Dto
data class MetaData(val isRune: Boolean, val tier: String, val type: String): Dto
...
public data class Champion(val allytips: MutableList<String>, val blurb: String, val enemytips: MutableList<String>, val id: Int, val image: Image, val info: Info, val key: String,
                    ...
                    val spells: MutableList<ChampionSpell>, val stats: Stats, val tags: MutableList<String>, val title: String): Dto
...
data class ChampionSpell(val altimages: MutableList<Image>, val cooldown: MutableList<Double>, val cooldownBurn: String, val cost: MutableList<Int>, val costBurn: String,
                         ...
                         val sanitizedDescription: String, val sanitizedTooltip: String, val tooltip: String, val vars: MutableList<SpellVars>): Dto

data class Info(val attack: Int, val defense: Int, val difficulty: Int, val magic: Int): Dto
data class Passive(val description: String, val image: Image, val name: String, val sanitizedDescription: String): Dto
data class Image(val full: String, val group: String, val sprite: String, val h: Int, val w: Int, val x: Int, val y: Int): Dto
...
data class Skin(val id: Int, val name: String, val num: Int): Dto
data class Stats(val armor: Double, val armorperlevel: Double, val attackdamage: Double, val attackdamageperlevel: Double, val attackrange: Double, val attackspeedoffset: Double,
                 ...
                 val movespeed: Double, val mp: Double, val mpperlevel: Double, val mpregen: Double, val mpregenperlevel: Double, val spellblock: Double, val spellblockperlevel: Double): Dto

data class LevelTip(val effect: MutableList<String>, val label: MutableList<String>): Dto
data class SpellVars(val coeff: MutableList<Double>, val dyn: String, val key: String, val link: String, val ranksWith: String): Dto
data class Block(val items: MutableList<BlockItem>, val recMath: Boolean, val type: String): Dto
data class BlockItem(val count: Int, val id: Int): Dto